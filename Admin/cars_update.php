        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                if (isset($_GET["updateid"])) {
                    ...
                    $result = mysqli_query(
                        $conn,
                        "SELECT cars_tbl.*, brands_tbl.brand_name 
                            FROM cars_tbl 
                            JOIN brands_tbl ON cars_tbl.brand_id = brands_tbl.brand_id 
                            WHERE cars_tbl.car_id='$id'"
                    );
                ...
                if (isset($_POST["btn"])) {
                    ...
                    $check = mysqli_query($conn, "SELECT * FROM cars_tbl WHERE car_name='$car' AND car_id != '$id'");
                    if (mysqli_num_rows($check) > 0) {
                        echo "Car name already exists!";
                    } else {
                        $sql = "UPDATE `cars_tbl` SET brand_id='$brand', car_name='$car' WHERE car_id='$id'";
                        ...
                        <form class="row g-3" method="post" id="registercar">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="brandname" id="brandname" class="form-select mb-3" aria-label="Default select example">
                                    ...
                                    ?>
                                        <option <?php if ($row["brand_id"] == $row1["brand_id"]) { ?> selected <?php } ?>
                                            value="<?php echo $row1["brand_id"]; ?>">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group"> <span class="input-group-text bg-transparent">🚗</span>
                                    <input type="text" value="<?php echo $row["car_name"] ?>" class="form-control border-start-0" placeholder="Enter Car Name" name="txtcar" />
                                </div>
                            </div>
                            <div class="col-12">
