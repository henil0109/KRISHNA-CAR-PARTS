		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
							<form method="post"><button type="submit" name="addbtn" class="btn btn-primary">Add Category</button></form>
                    <?php 
				
					if(isset($_POST["addbtn"]))
					{
						 echo "<script> window.location = 'category_add.php';</script>";
					}		
                    ?>
						</div>
					</div>
				...
				<?php 
					...
					if(isset($_POST["delete-btn"]))
					{
						...
						$result = mysqli_query($conn,"delete from categories_tbl where category_id='$did'") or die(mysqli_error($conn));
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<a href="category_update.php?updateid=<?php echo $row["category_id"] ?>" class="btn btn-outline-primary px-1">Update</a>&nbsp;
												<button type="button" data-id="<?php echo $row["category_id"] ?>" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-outline-primary px-1 btndelete">Delete</button>
