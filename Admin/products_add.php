                        ...
                        <div class="card-body p-5">
                            ...
                            <form class="row g-3" method="post" id="registerForm" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!--<div>
										<input type="text" class="form-control border-start-1" name="inputdesgn" id="inputdesgn" placeholder="Enter job desgnation" />
									</div>-->
                                </div>
                                ...
                                <div class="col	-12">
                                    ...
                                    <div>
                                        <input type="text" class="form-control border-start-1" name="inputname" id="inputname" placeholder="Enter Car-Part Name" />
                                    </div>
                                </div>

                                <div class="col	-12">
                                    <label for="inputimg" class="form-label"><b>Product Image</b></label>
                                    <div>
                                ...
                                <div class="col-12">
                                    <label for="inputdesc" class="form-label"><b>Part Descreption</b></label>
                                    <textarea class="form-control" name="inputdescp" id="inputdescp" placeholder="Enter part details" rows="3"></textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div>
                                        <input type="text" class="form-control border-start-1" id="inputprice" name="inputprice" placeholder="Enter Price of the Part" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div>
                                        <input type="text" class="form-control border-start-1" id="inputquantity" name="inputquantity" placeholder="Enter Part Quantity
                                        " />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div>
                                        <input type="text" class="form-control border-start-1" id="inputlevel" name="inputlevel" placeholder="Enter Reorder Level for the Part" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-danger px-5" name="btn">Register</button>
                            ...
                            if (isset($_POST["btn"])) {
                                ...
                                $sql = "INSERT INTO products_tbl(part_name, model_id, part_description, category_id, price, stock, reorder_level, part_image)
       									 VALUES ('$name','$model','$descp','$category','$price','$quantity','$level','$filename')";
