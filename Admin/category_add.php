		...
		<div class="page-wrapper">
			<div class="page-content">
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Manage Categories</div>
					<div class="ps-3">
				...
				if (isset($_POST["btn"])) {
					...
					$result = mysqli_query($conn, "select * from categories_tbl where category_name='$category'");
					if (mysqli_num_rows($result) <= 0) {
						$sql = "INSERT INTO `categories_tbl`(category_name,description) VALUES ('$category','$descp')";
				...
				<div class="card border-top border-0 border-4 border-danger">
					<div class="card-body p-5">
						...
						<hr>
						<form class="row g-3" method="post" id="registercategory">
							...
							<div class="col-12">
								...
								<div class="input-group"> <span class="input-group-text bg-transparent">🛡️</span>
									<input type="text" class="form-control border-start-0" placeholder="Enter Category Name" name="txtcategory" />
								</div>
							</div>
                            <div class="col-12">
								...
								<div class="input-group"> <span class="input-group-text bg-transparent">📝</span>
									<input type="textarea" class="form-control border-start-0" placeholder="Enter Details" name="txtdescp" />
								</div>
							</div>
